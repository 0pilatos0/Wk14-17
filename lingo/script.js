...
var gameloop = function(){
  ...
  input.onkeypress = function(event) {
    if (event.key == "Enter" || event.keyCode == 13) {
      document.getElementById('smallMsg').innerHTML = "Veel speelplezier";
      ...
      if(guess.length !== 5){
        document.getElementById('smallMsg').innerHTML = "Het woord wat je raad moet 5 letters hebben";
        if(pressn==5){
          end("Sorry maar je hebt verloren");
        }
        pressn++;
      ...
      for( i=0; i<childDivs.length; i++ ) {
        ...
        if(c == 5) {
          end("Gefeliciteerd je hebt gewonnen");
        } 
        else if (pressn == 5){
          document.getElementById('smallMsg').innerHTML = "Correcte woord: " + rand;
          end("Sorry maar je hebt verloren");
        } 
      } 
      pressn++; 
...
var playagain = function(){
  ...
  document.getElementById('smallMsg').innerHTML = "Veel speelplezier"; // small message
